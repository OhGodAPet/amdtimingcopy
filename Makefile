...
amdtimingcopydbg: amdtimingcopy.c navi10_json.c navi21_json.c vbios-tables.h VRAMInfo.h vram/navi.h
	$(CC) $(CFLAGS) $(DBGCFLAGS) amdtimingcopy.c navi10_json.c navi21_json.c $(LDFLAGS) -o amdtimingcopy

amdtimingcopy: amdtimingcopy.c navi10_json.c navi21_json.c vbios-tables.h VRAMInfo.h vram/navi.h
